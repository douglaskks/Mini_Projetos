...
class PilulaAzul extends StatefulWidget {
  const PilulaAzul({super.key}); // Construtor da classe PilulaAzul.

  @override
  State<PilulaAzul> createState() =>
      _PilulaAzulState(); // Cria o estado do widget PilulaAzul.
}

// Define a classe de estado para o widget PilulaAzul.
class _PilulaAzulState extends State<PilulaAzul> {
  @override
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage(
              'lib/images/Imagem3.png'), // Define uma imagem de fundo para o contêiner.
            ...
            Padding(
              ...
              child: Container(
                ...
                child: const Text(
                  ...
                  'Permanecer na Ignorância: Escolher a pílula azul simboliza evitar confrontar verdades desconfortáveis, optando por uma vida mais simples e confortável, mesmo que isso signifique ignorar aspectos importantes da realidade.',
                  style: TextStyle(
